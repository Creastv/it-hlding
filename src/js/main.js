...
$(".hamburger").click(function(){  
    ...
    $(".page-title").toggleClass("page-title-active");
  });  
}); 
...
var spaceHeight = header.offsetHeight;
  $('#bg-opacity').css("height", spaceHeight + 110 + 'px');

$(document).on( 'scroll', function(){
if ($(window).scrollTop() > spaceBanner.offsetHeight) {
    $('.navbar').addClass( "sticky" );
    $('.page-title').css("marginTop", + navBar.offsetHeight);
} else {
    $('.navbar').removeClass( "sticky" );
    $('.page-title').css("marginTop", "0px");
}
