...
// function fadeUpIi(ev) {
//   var sections =  document.querySelectorAll('.fade-up-it');
//   // var distanceToTop = mock.getBoundingClientRect().top;
//   sections.forEach(function(section) {
//     section.style.transform = "translate(0px, 150px)";
//     section.style.opacity = "0.1";
//     // section.style.webkitTransform = "translate(0px, 300px)";
//     // section.style.mozTransform = "translate(0px, 300px)";
    
//     section.getBoundingClientRect().top;
//     if(section.getBoundingClientRect().top <= window.screen.height - 300){
//       section.style.transform = "translate(0px, 0px)";
//       section.style.opacity = "1";
      
//     // section.style.webkitTransform = "translate(0px, 0px)";
//     // section.style.mozTransform = "translate(0px, 0px)";
//       console.log('yes')
//     } else {
//       mock.classList.remove('mock-show');
//     }
...
//   // window.addEventListener('scroll', fadeUpIi);
// }
