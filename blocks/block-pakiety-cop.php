...
<section class="pakiety <?php echo ($block['className']); ?>">
    ...
    <meta itemprop="serviceType" content="<?php the_field('nad_tytulem'); ?>" />
        <div class="row" itemprop="hasOfferCatalog" itemscope itemtype="http://schema.org/OfferCatalog" >
            ...
            <?php if( have_rows('pakiety') ): ?>
               ...
               <?php while ( have_rows('pakiety') ) : the_row(); ?>
                    ...
                    <div itemprop="itemListElement" itemscope itemtype="http://schema.org/OfferCatalog" class="col-pa my-auto  <?php if ( get_sub_field('najczesciej_wybierany') == true ) { echo "show";} ?> <?php if ( get_sub_field('najczesciej_wybierany') == true ) { echo "col-md-4";} else { echo "col-md-3";} ?>">
                            ...
                            <header>
                                <div class="tab">
                                    <?php if(get_sub_field('tytul')) :?>
                                        ...
                                        <?php } ?>
                                        <h3 itemprop="name" ><?php  the_sub_field('tytul'); ?></h3>
                                    <?php endif; ?>
